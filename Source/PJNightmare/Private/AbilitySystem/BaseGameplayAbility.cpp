...
UBaseAbilitySystem* UBaseGameplayAbility::GetBaseAbilitySystemComponentFromActorInfo() const
{
	return Cast<UBaseAbilitySystem>(CurrentActorInfo->AbilitySystemComponent);
